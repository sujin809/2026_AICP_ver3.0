"""Strict API-call policy used only by the real-news Community AB path.

The generic OpenRouter client is shared with exploratory scripts.  This module
keeps paper-specific fail-closed rules out of those legacy entrypoints and
makes the policy serializable into a resolved study manifest.
"""
