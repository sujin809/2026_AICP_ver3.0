...
| `dim_2` | 현재 valuation 관점 | 100자 |
| `dim_3` | 금리·환율·경기·반도체 업황 등 거시·산업 관점 | 100자 |
| `dim_4` | 시장 심리와 투자자 분위기 | 100자 |
| `dim_5` | persona에 따른 뉴스·커뮤니티 해석 | 100자 |
| `dim_6` | 자기 판단 능력, 반복 오류, 위험관리 성찰 | 100자 |
